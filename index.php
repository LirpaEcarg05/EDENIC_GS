                    ...
                    <div class="cta-content bg-img background-overlay" style="background-image: url(img/bg-img/bg27.png);">
                        <div class="h-100 d-flex align-items-center justify-content-end">
                            <div class="cta--text">
                                ...
                                <a href="login.php" class="btn essence-btn">Buy Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="popular-products-slides owl-carousel">
                        ...
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-description">
                                ...
                                <p class="product-price">Php 80.00</p>
                        ...
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-description">
                                ...
                                <p class="product-price"><span class="old-price">Php 75.00</span> Php 55.00</p>
