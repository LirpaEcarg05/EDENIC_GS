...
<body>
    ...
    <div class="breadcumb_area bg-img" style="background-image: url(img/bg-img/sbg.png);">
                                ...
                                <ul id="menu-content2" class="menu-content collapse show">
                                    ...
                                    <li data-toggle="collapse" data-target="#clothing">
                                        ...
                                        <ul class="sub-menu collapse show" id="clothing">
                                            ...
                                            <li><a href="#">Feadle Leaf Fig</a></li>
                                            <li><a href="#">Rubber Plant</a></li>
                                            <li><a href="#">Bamboo Palm</a></li>
                                    ...
                                    <li data-toggle="collapse" data-target="#shoes" class="collapsed">
                                        ...
                                        <ul class="sub-menu collapse" id="shoes">
                                            <li><a href="#">Caladium</a></li>
                                            <li><a href="#">Colues</a></li>
                                            <li><a href="#">Tropical Hibiscus</a></li>
                                            <li><a href="#">Generanium Plant</a></li>
                                            <li><a href="#">Boxwood and Myrtle</a></li>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-wrapper">
                                    ...
                                    <div class="product-img">
                                        <img src="img/product-img/indoor/product21.jpg" alt="">
                                        <!-- Hover Thumb -->
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-wrapper">
                                    ...
                                    <div class="product-img">
                                        <img src="img/product-img/indoor/product21.jpg" alt="">
                                        <!-- Hover Thumb -->
                                        <img class="hover-img" src="img/product-img/indoor/indoor/product21.jpg" alt="">
